          ...
          <div class="col-md-9">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Electricity bill form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('electricity.update',[$edit])}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
...
// Get the values of the two numbers to add
var num1 = document.getElementById("due").value;


// Convert the strings to numbers and add them
var result = parseInt(num1)/100 ;
